...
always @(host_intf_wr_i, rdpipeline_r, ba_r, timer_r, sdatadir_r, wrtimer_r, cmd_r, activerow_r[0], activerow_r[1], activerow_r[2], activerow_r[3], activeflag_r[0], activeflag_r[1], activeflag_r[2], activeflag_r[3], wr_in_progress_s, reftimer_r, row_s, activate_in_progress_s, doactivate_s, ba_x, host_intf_rd_i, saddr_r, bank_s, col_s, rd_in_progress_s, activebank_r, rastimer_r, rfshcntr_r, state_r) begin: SDRAM_CNTL_COMB_FUNC
    integer index;
...
always @(posedge clk, posedge host_intf_rst_i) begin: SDRAM_CNTL_SEQ_FUNC
    integer index;
...
always @(cmd_r, saddr_r, bank_s, sdata_r, sdatadir_r) begin: SDRAM_CNTL_SDRAM_PIN_MAP
    sd_intf_cke = 1;
    sd_intf_cs = 0;
    sd_intf_ras = cmd_r[2];
    sd_intf_cas = cmd_r[1];
...
always @(sdramdata_r, activerow_r[0], activerow_r[1], activerow_r[2], activerow_r[3], rastimer_r, activeflag_r[0], activeflag_r[1], activeflag_r[2], activeflag_r[3], rdpipeline_r, bank_s, activebank_r, sd_intf_dq, row_s, wrtimer_r) begin: SDRAM_CNTL_DO_ACTIVE
